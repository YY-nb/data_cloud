...
CREATE TABLE `folder`  (
           ...
           `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '文件或文件夹名称',
...
CREATE TABLE `sys_file`  (
             ...
             `path` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '文件相对路径',
...
CREATE TABLE `sys_user`  (
             `user_id` char(32) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `user_role` (
         ...
         PRIMARY KEY (`id`)
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '用户角色关系' ROW_FORMAT = Dynamic;
